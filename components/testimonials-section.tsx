    ...
    <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8 sm:mb-12">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-text-primary mb-3 sm:mb-4 tracking-tight">
        ...
        >
          ...
          {[...testimonials, ...testimonials].map((testimonial, index) => (
            ...
            >
              <div className="mb-4">
                <svg
                  className="w-6 h-6 sm:w-8 sm:h-8 text-primary mb-3 sm:mb-4"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <div>
                <p className="font-semibold text-text-primary text-sm sm:text-base">{testimonial.author}</p>
