...
export function DashboardSidebar({ onClose }: DashboardSidebarProps) {
  ...
  return (
    <aside className="w-64 bg-dark-green-800/95 md:bg-dark-green-800/30 backdrop-blur-sm border-r border-cyber-green/30 min-h-[calc(100vh-4rem)] pt-8 md:pt-8 pb-8 overflow-y-auto">
